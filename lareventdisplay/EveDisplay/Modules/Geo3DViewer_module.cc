...
#ifndef EVED_GEO3DVIEWER_MODULE_CC
#define EVED_GEO3DVIEWER_MODULE_CC
...
namespace
{
  std::string TPC3D("Geo3D");
}
namespace eved
{
  typedef eved::GenericViewerMaker<TPC3D, eved::SimpleGeoMaker> Geo3DViewer;
...
DEFINE_ART_MODULE(eved::Geo3DViewer)
